...
This is a website that will be used mainly by current and prospect fans from the Monkees  in order to keep up to date with the latest news, know more about the band and listen the Monkees songs.
...
- [the band-part2.html mockup](https://github.com/elenasacristan/the-monkees-website/tree/master/mockups/theband2.png)
- [the band-part3.html mockup](https://github.com/elenasacristan/the-monkees-website/tree/master/mockups/theband3.png)
- [news.html mockup](https://github.com/elenasacristan/the-monkees-website/tree/master/mockups/news.png)
...
- As a current / potential fan I want to know when the next concerts are scheduled, so I can decide if I can go or not.
...
- As an event organiser I want to know about the opinion from other people who booked the band before, so I can decide if I want the band to perform in my event or not.
- As an event organiser I want to to contact the band to see if they can play at my event.
- As a member of the band I want to know the type of events, number of people, days, times and places where there event organisers would like to book the band.
...
#### Footer
In the footer the user can see the contact details email and phone (I used dummy contact details) and also the social media links in case the user wants to follow the band in social media.
...
##### contact.html
- The photos on this pages were obtained from google images using the Advance Search and selecting “free to use, share or modify, even commercially”.
